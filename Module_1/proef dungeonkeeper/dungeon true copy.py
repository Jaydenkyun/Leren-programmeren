...
print("Typ (1) voor de linkerdeur")
print("Typ (2) voor de rechterdeur")
...
if deur_keuze1 == "1":
    ...
    print('Typ (1) om naar kamer 6 te gaan.')
    print('Typ (2) om naar kamer 3 te gaan.')
    ...
    if deur_keuze2 == "1":
        ...
        print("Je ziet een deur die terug leidt naar kamer 3.")
        input("Typ enter om verder te gaan naar kamer 3...")
        kamer = 3
...
# ===========================================
    ...
    print("Je moet dobbelen: hoger dan 7 = rupee, lager = schade.")
    ...
    if dobbelsteen_uitkomst == 7:
        ...
        print(f"Je rolt een {dobbelsteen_uitkomst}. Je krijgt een rupee.")
        player_rupee_amount += 1
    else:
    ...
    if deur_keuze8 == "1":
        ...
        print(f"Het altaar projecteert een {altaar_kans} boven zich.")

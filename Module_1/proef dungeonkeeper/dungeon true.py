...
if deur_keuze1 == "1":
    ...
    if deur_keuze2 == "1":
        ...
        deur_keuze3 = input("pak je deur voor je typ (1) of pak jij de deur rechts van je typ (2)")
        if deur_keuze3 == "2":
            ...
            print("Typ (1) voor de kamer rechts van je.")
            print("Typ (2) voor de kamer voor je.")
            ...
            if deur_keuze8 == "1":
                ...
                if altaar_kans == "schild":
                    ...
                    if shop_items_keuze == "schild":
                        ...
                        print("Je koopt niets dus je bent een jood.")

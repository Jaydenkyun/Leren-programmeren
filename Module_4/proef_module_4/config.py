...
COST_INN_HUMAN_SILVER_PER_NIGHT = data["constants"]["COST_INN_HUMAN_SILVER_PER_NIGHT"]
COST_INN_HORSE_COPPER_PER_NIGHT = data["constants"]["COST_INN_HORSE_COPPER_PER_NIGHT"]